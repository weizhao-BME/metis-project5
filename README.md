...
The dataset was downloaded from ([Moosavi et al. (2019a)](https://arxiv.org/pdf/1909.09638.pdf); [Moosavi et al. (2019b)](https://arxiv.org/pdf/1906.05409.pdf)), where the authors collected the data from MapQuest and bing and are continuously updating the dataset. The dataset includes about 4.2 million traffic accidents which cover 49 states of the US from 2016 to 2020. All the features are listed below [(REF)](https://smoosavi.org/datasets/us_accidents). 
